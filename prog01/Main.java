...
public class Main {
  public static void main (String[] args) {
    ...
    System.out.println(c1 instanceof Laptop); //false
    System.out.println(c2 instanceof Laptop); //true
    System.out.println(n1 instanceof Computer);//true
 ...
 //    System.out.println(c2.getWeight());
    ...
    System.out.println(c2.computePower() + "c2 calling computePower()");
  }
}
